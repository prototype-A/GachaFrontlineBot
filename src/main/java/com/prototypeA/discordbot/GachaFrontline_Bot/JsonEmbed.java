...
public class JsonEmbed {
	...
	public static Consumer <? super EmbedCreateSpec> embedMessage(String message, String color) {
		return spec -> spec.setDescription(message)
						.setColor(Color.of(Integer.parseInt(color)));
	}

	public static Consumer <? super EmbedCreateSpec> errorEmbed(String message) {
	...
	/**
	 * Based off of Discord4J 2.x.x EmbedBuilder functionality
	 */
	...
	public static void webhookPost(String webhookToken, String content, String contentType) {
		...
		try {
			...
			if (responseCode == 401 || responseCode == 403) {
				...
				throw new Exception("Error " + Integer.toString(responseCode));
			}
